...
n_hidden = 128
n_layers = 2
n_batch = dataset.uns["_scvi"]["summary_stats"]["n_batch"]

# train the conditional VAE
model = CondSCVI(dataset, n_latent=n_latent, n_layers=n_layers, n_hidden=n_hidden)
...
spatial_model = stVI(dataset, dataset.uns["_scvi"]["summary_stats"]["n_labels"], state_dict, 
                    n_latent=n_latent, n_hidden=n_hidden, n_layers=n_layers, n_batch=n_batch)
